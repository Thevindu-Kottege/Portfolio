...
const PHOTOGRAPHY_PHOTOS = [
  ...
  {
    id: 2,
    title: "Brutalist Shadow Study",
    category: "Architecture",
    seriesId: "urban-geometry",
    date: "August 2025",
    location: "Kollupitiya, Colombo",
    image: "assets/images/proj2_youtube_branding.jpg",
    aspectRatio: "portrait",
    description: "Strong diagonal shadows falling across ribbed concrete balconies at mid-day.",
    exif: {
      camera: "Sony A7 IV",
      lens: "FE 24-70mm f/2.8 GM II",
      settings: "1/500s · f/8.0 · ISO 100",
    },
    featured: true,
  },
  {
  ...
  {
    id: 5,
    title: "Neon Stalls in Pettah Market",
    category: "Street",
    seriesId: "colombo-after-rain",
    date: "September 2025",
    location: "Pettah, Colombo",
    image: "assets/images/proj3_video_reel.jpg",
    aspectRatio: "tall",
    description: "Vibrant ambient light and trade in the bustling merchant streets of Old Pettah.",
    exif: {
      camera: "Sony A7 IV",
      lens: "FE 50mm f/1.2 GM",
      settings: "1/200s · f/2.0 · ISO 800",
    },
    featured: true,
  },
  {
